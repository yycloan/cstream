                ...
                <div className="grid grid-cols-2 gap-2">
                  {movie.multipleDownloads.map((episode, index) => (
                    <Link
                      ...
                      className="bg-gray-800 hover:bg-gray-700 text-white p-3 rounded-lg transition-colors flex items-center justify-between"
                    >
                      <span className="text-sm font-medium">{episode.label}</span>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {movie.multipleDownloads.map((episode, index) => (
                        <Link
                          key={index}
                          href={`/movie/${slug}/episode/${index}`}
                          className="bg-gray-800 hover:bg-gray-700 text-white p-4 rounded-lg transition-colors flex items-center justify-between group"
                        >
